			...
			if(!_absence){
				...
				switch (this.name) {
					...
					case "pnjVillageois6_mc":
						...
						//Exemple: Dialogue multi-branche
						_nomSimple = "Martin";
						tSequence=[
					/*0*/	[_REPLIQUE, "Salut Horas, comment vas-tu ?"],
					/*1*/	[_CHOIX, "Bien et toi ?", "Bof, ca peut aller..."],
					/*2*/	[_BRANCHE, 1],
					/*3*/		[_REPLIQUE, "Très bien merci !"],
					/*4*/		[_REPLIQUE, "Mes patates poussent à merveille !"],
					/*5*/		[_QUIT],
					/*6*/	[_BRANCHE, 2],
								[_REPLIQUE, "Ah bon !? Voudrais tu une patate pour te consoler ?"],
								[_CHOIX, "Mais oui, bien sûr !", "Non merci. Je n'aime pas les patates", "Vient-elle de votre jardin ?"],
								[_BRANCHE, 1],
									[_REPLIQUE, "Tiens mon petit !"],
									[_OBJET, "Patate"],
								[_QUIT],
								[_BRANCHE, 2],
									[_REPLIQUE, "Pourtant les patates sont une si bonne source de vitamines !"],
								[_QUIT],
								[_BRANCHE, 3],
									[_REPLIQUE, "Mais oui, bien entendu !"],
									[_REPLIQUE, "Très bien alors, je veux bien", "Horas"],
									[_OBJET, "Patate"],
								[_QUIT]
						];
						break;
					...
					case "pnjNova_mc":
						...
						tSequence=[
							...
							[_REPLIQUE, "Est-ce que je peux vous accompagner ?"],
							[_CHOIX, "Bien entendu !", "Non. Je dois accomplir cette mission seul..."],
							[_BRANCHE,1],
								[_REPLIQUE, "Super !"],
								[_EQUIPIER],
								[_DISPARITION],
