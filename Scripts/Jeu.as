package  {
	...
	public class Jeu extends MovieClip {
		...
		private var _tTableauxPacifiques:Array = ["Village", "MaisonAmi", "MaisonMaman", "MaisonChamane", "Chateau", "SalleDuRoi", "Caverne", "Auberge"];
		private var _tTableauxDangereux:Array = ["Foret", "Foret2", "Foret3" ,"Foret4","Ravin", "Rocaille", "Neige1", "Neige2", "Neige3", "Plaine1", "Plaine2", "Pecheur", "Sorciere", "VieuxSage"];
		...
		public function Jeu() {
			...
			_horas.initParam(  "Horas",   125,   125,    50,    50,      25,      25,          5,          5,          20,   1,     0,       100, true);
			...
			_tPersos = [_horas]; //ajout du perso principal dans le Array de l'équipe
		...
		******************************************************************************/
		private function init(e:Event):void{
			...
			var m:Magasin = new Magasin();
			_tMagasins.push("Village");
			_tMagasins.push(m);
		} //init
		...
		******************************************************************************/
		public function declencherDialogue(tSequence:Array, demandeur:MovieClip):Boolean {
			if(_dialogue.declencherSiOk(tSequence, demandeur)){
				...
				_ecranDeJeu.arreterJoueur(_horas);
		...
		******************************************************************************/
		public function arretFrappeClavier(e:KeyboardEvent):void {
			...
			if(_ecranDeJeu is Tableau){
				...
				if(!_gauche && !_droite && !_haut && !_bas){ _ecranDeJeu.arreterJoueur(_horas); } //au besoin, arret du cycle de marche
			} //if
		} //arretFrappeClavier
		...
		******************************************************************************/
		private function loop(e:Event):void{
			...
			if(_ecranDeJeu is Tableau){
				...
				if(vX!=0 || vY!=0){ _ecranDeJeu.deplacerJoueur(_horas, vX, vY); } //le déplacement est demandé seulement si il y a un vecteur pertinant!
			} //if(c'est un Tableau)
		} //loop
		...
		******************************************************************************/
		public function ajouterObjet(monObjet:MovieClip):void{
			_tObjets.push(monObjet);
		} //ajouterObjet
		
		public function enleverObjet(index:uint):void{
			_tObjets.splice(index,1);
		}
		...
		******************************************************************************/
		private function fermetureTableauEnCours():void{
			if(_ecranDeJeu is Tableau){
				_memPosPerso = _horas.getPosPerso();
		...
		******************************************************************************/
		...
		public function getTMagasins():Array{ return _tMagasins; }
